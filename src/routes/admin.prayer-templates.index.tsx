          ...
          <table className="w-full min-w-[760px] border-separate border-spacing-0 text-sm">
            <thead>
              <tr className="text-left text-xs tracking-wider text-stone-500 uppercase">
                ...
                <th className="border-b border-stone-800 px-3 py-2">en</th>
                <th className="border-b border-stone-800 px-3 py-2">yo</th>
            ...
            <tbody>
              {data.templates.map((template) => {
                ...
                return (
                  <tr key={template.id} className="hover:bg-stone-900">
